...
from experiments import run_baseline_experiment, run_aux_conf_experiment, run_bootstrapping_experiment
...
if __name__ == "__main__":
    ...
    train_data, test_data, ground_truth = load_and_preprocess_data()
    ...
    # Visualize results
    plot_scaling_behavior(baseline_results, aux_conf_results, bootstrap_results)
